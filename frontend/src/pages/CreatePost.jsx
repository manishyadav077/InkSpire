...
import { Sparkles, Wand2, Image as ImageIcon, Send, Type } from "lucide-react";
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto min-h-screen pb-24">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
        <div>
          <h1 className="text-4xl font-outfit font-extrabold tracking-tight">Create a Masterpiece</h1>
          <p className="text-slate-500 mt-1">Share your thoughts with the global community</p>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">High resolution landscape images work best</p>
              </div>
            </div>
